...
consonants = strvcat('b', 'd', 'g', 'p', 't', 'k', 'dx', 'q', 'jh', 'ch', 's', 'sh', 'z', 'zh', 'f', 'th', 'v', 'dh', 'm', 'n', 'ng', 'em', 'en', 'eng', 'nx', 'l', 'r', 'w', 'y', 'hh', 'hv', 'el');
closures = strvcat('bcl','dcl','gcl','pcl','tck','kcl');
...
for q=1:number_of_windows
    ...
    if ~(isempty(strmatch(training_labels{q}, consonants, 'exact')))
